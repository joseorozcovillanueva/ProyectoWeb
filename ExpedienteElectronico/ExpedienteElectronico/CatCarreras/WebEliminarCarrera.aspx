<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Principal.Master" CodeBehind="WebEliminarCarrera.aspx.cs" Inherits="WebExpedienteElectronico.WebEliminarCarrera" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h3>Confirmación de Eliminación | Carrera | ID : <asp:Label ID="lblID" runat="server" Text="Label"></asp:Label></h3> 
